...
function TimeColsAxisCell(props) {
  ...
  return createElement(ViewContextType.Consumer, null, (context) => {
    ...
    }, renderProps, generatorName: "slotLabelContent", customGenerator: options.slotLabelContent, defaultGenerator: renderInnerContent, classNameGenerator: options.slotLabelClassNames, didMount: options.slotLabelDidMount, willUnmount: options.slotLabelWillUnmount }, (InnerContent) => createElement(
      "div",
...
var TimeBodyAxis = class extends BaseComponent {
  render() {
    return this.props.slatMetas.map((slatMeta) => createElement(
      "tr",
      { key: slatMeta.key },
    ...
    this.renderHeadAxis = (rowKey, frameHeight = "") => {
      ...
      if (options.weekNumbers && rowKey === "day") {
        return createElement(WeekNumberContainer, { elTag: "th", elClasses: [
          ...
          "aria-hidden": true
        }, date: range.start, defaultFormat: DEFAULT_WEEK_NUM_FORMAT }, (InnerContent) => createElement(
          "div",
          { className: [
    ...
    this.renderTableRowAxis = (rowHeight) => {
      ...
      return (
        ...
        createElement(ContentContainer, { elTag: "td", elClasses: [
          ...
          "aria-hidden": true
        }, renderProps, generatorName: "allDayContent", customGenerator: options.allDayContent, defaultGenerator: renderAllDayInner, classNameGenerator: options.allDayClassNames, didMount: options.allDayDidMount, willUnmount: options.allDayWillUnmount }, (InnerContent) => createElement(
          "div",
          { className: [
            "fc-timegrid-axis-frame",
            "fc-scrollgrid-shrink-frame",
...
var TimeCol = class extends BaseComponent {
  ...
  render() {
    ...
    ], elAttrs: Object.assign({ role: "gridcell" }, props.extraDataAttrs), date: props.date, dateProfile: props.dateProfile, todayRange: props.todayRange, extraRenderProps: props.extraRenderProps }, (InnerContent) => createElement(
      "div",
    ...
    return createElement(
      ...
      segPlacements.map((segPlacement) => {
        ...
        return createElement(
          ...
          createElement(TimeColEvent, Object.assign({ seg, isDragging, isResizing, isDateSelecting, isSelected: instanceId === eventSelection, isShort }, getSegMeta(seg, todayRange, nowDate)))
        );
      })
    );
  }
  ...
  renderNowIndicator(segs) {
    ...
    return segs.map((seg, i) => createElement(
...
function renderPlainFgSegs(sortedFgSegs, { todayRange, nowDate, eventSelection, eventDrag, eventResize }) {
  ...
  return createElement(Fragment, null, sortedFgSegs.map((seg) => {
    ...
    return createElement(
      ...
      createElement(TimeColEvent, Object.assign({ seg, isDragging: false, isResizing: false, isDateSelecting: false, isSelected: instanceId === eventSelection, isShort: false }, getSegMeta(seg, todayRange, nowDate)))
    );
  }));
}
