...
var TableView = class extends DateComponent {
  ...
  renderHScrollLayout(headerRowContent, bodyContent, colCnt, dayMinWidth) {
    ...
    return createElement(
      ViewContainer,
      { elClasses: ["fc-daygrid"], viewSpec: context.viewSpec },
      createElement(ScrollGrid, { liquid: !props.isHeightAuto && !props.forPrint, forPrint: props.forPrint, collapsibleWidth: props.forPrint, colGroups: [{ cols: [{ span: colCnt, minWidth: dayMinWidth }] }], sections })
    );
  }
};
...
var TableCell = class extends DateComponent {
  ...
  render() {
    ...
    return createElement(DayCellContainer, { elTag: "td", elRef: this.handleRootEl, elClasses: [
      ...
      props.showWeekNumber && createElement(WeekNumberContainer, { elTag: "a", elClasses: ["fc-daygrid-week-number"], elAttrs: buildNavLinkAttrs(context, date, "week"), date, defaultFormat: DEFAULT_WEEK_NUM_FORMAT }),
      !renderProps.isDisabled && (props.showDayNumber || hasCustomDayCellContent(options) || props.forceDayTop) ? createElement(
        "div",
        ...
        createElement(
          ...
          createElement("a", { className: "fc-daygrid-day-number" }, " ")
        )
      ) : void 0,
      createElement(
        "div",
...
//# sourceMappingURL=chunk-DNEVFKRB.js.map
